...
class UserPopUpMenu extends StatelessWidget {
  const UserPopUpMenu({required this.notifier, required this.gameNotifier, super.key});
      ...
      itemBuilder:
          (context) => <PopupMenuEntry<String>>[
            const PopupMenuItem<String>(
              value: 'delete',
              child: Row(children: [Icon(Icons.arrow_back_outlined), SizedBox(width: 8), Text('Delete User')]),
            ),
            const PopupMenuItem<String>(
              value: 'update',
              child: Row(children: [Icon(Icons.refresh_rounded), SizedBox(width: 8), Text('Update Username')]),
            ),
          ],
    );
  }
